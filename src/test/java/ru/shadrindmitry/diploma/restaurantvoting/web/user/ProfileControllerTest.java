...
import ru.shadrindmitry.diploma.restaurantvoting.to.UserTo;
...
import static ru.shadrindmitry.diploma.restaurantvoting.web.user.ProfileController.REST_URL;
import static ru.shadrindmitry.diploma.restaurantvoting.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void update() throws Exception {
        ...
        USER_MATCHER.assertMatch(userRepository.getExisted(USER1_ID), UserUtil.updateFromTo(new User(user1), updatedTo));
    }
